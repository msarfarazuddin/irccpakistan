    ...
    return (
        <section className="bg-white from-gray-100 to-gray-200 py-16 px-4">
            ...
            `}
                ...
                <p className="mx-auto mt-10 max-w-4xl text-sm leading-relaxed text-gray-600 md:text-base">
                    If you experience pelvic heaviness or pressure alongside these symptoms, it may also be worth discussing{" "}
                    <Link
                    ...
                    with our team, as both conditions can sometimes present together.
                </p>
            </div>
        </section>
    );
