                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-4">
                            <div className="relative w-full h-[280px] sm:h-[360px] lg:h-[420px] overflow-hidden rounded-xl">
                                <Image
                                    src="/Haemorrhoids.png" // <-- apni image public me rakho
                        ...
                        <div className="lg:col-span-8">
                            <h4 className="text-[22px] sm:text-[35px] text-[30px] lg:text-[45px]  leading-tight text-slate-900">
                                What Are {" "}
                                <span className="text-[#0b4aa2] font-extrabold">Haemorrhoids?</span>
                            </h4>

                            <p className="mt-4 text-[16px] sm:text-[16px] leading-relaxed text-slate-700">
                                Hemorrhoidal Artery Embolization (HAE) is a minimally invasive, image-guided treatment for bleeding haemorrhoids. An interventional radiologist blocks the small arteries supplying the haemorrhoids, reducing blood flow so they shrink and symptoms improve without surgical cuts. Similar to <a href="/Uterine-Fibroid-Embolization"> Uterine Fibroid Embolization</a> and <a href="/Varicocele-Embolization"> Varicocele Embolization</a>, HAE uses the same proven embolization technique to treat vascular conditions without surgery.
                            </p>
                        </div>
                    </div>
                </div>
