                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-8">
                            ...
                            <p className="mt-4 text-[16px] sm:text-[16px] leading-relaxed text-slate-700">
                                Haemorrhoids are swollen veins in the lower rectum or anus. They can be internal (inside the rectum) or external (around the anus) and often develop due to constipation, straining, pregnancy, or prolonged sitting.
                            </p>
                        </div>
                    </div>
                </div>
