    ...
    return (
        <section className="bg-white from-gray-100 to-gray-200 py-16 px-4">
            ...
            `}
                ...
                {/* Button */}
                <div className="mt-12">
                    <p className="mx-auto mb-5 max-w-3xl text-sm font-normal text-gray-600 md:text-base">
                        Patients experiencing vascular or pelvic pain may also wish to explore our{" "}
                        <Link
                        ...
                        , which similarly addresses abnormal vascular flow using embolization.
                    </p>
