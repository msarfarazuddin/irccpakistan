...
export default function UterineFibroidsSection() {
  return (
    <section className="bg-[#ffffff] py-16 px-4 bg-center bg-no-repeat" style={{ backgroundImage: "url('/faq.png')" }}>
      <div className="max-w-full mx-auto text-center flex flex-col justify-center items-center">
        ...
        <p className="text-gray-600 mb-8 max-w-2xl ">
          Uterine fibroids are common, non-cancerous tumors of the uterus. While fibroids themselves are benign, women experiencing pelvic symptoms should also be evaluated for related conditions such as <a href="/Endometriotic-Ovarian-Cyst-Ablation"> Endometriotic Ovarian Cyst</a> and <a href="/Pelvic-Congestion-Syndrome-Treatment"> Pelvic Congestion Syndrome</a>, which can present with overlapping symptoms.
        </p>
