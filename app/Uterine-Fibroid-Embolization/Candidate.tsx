    ...
    return (
        <section className="relative  bg-[#0E58A8E5] from-gray-100 to-gray-200 py-16  px-4"  >
            ...
            `}
                ...
                <div className="mt-12">
                    <p className="text-white max-w-4xl mx-auto mb-10 text-sm md:text-base">
                        You are also a candidate if you prefer a non-surgical uterine fibroid treatment option that will preserve your uterus. Women concerned about their overall reproductive health may also benefit from learning about <a href="/Fallopian-Tube-Recanalization"> Fallopian Tube Recanalization</a>, another minimally invasive procedure that supports uterine and fertility health. Make sure to discuss all options with our IRCC team before making a decision.        </p>
                </div>
            </div>
        </section>
    );
