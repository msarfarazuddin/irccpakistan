                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-4">
                            <div className="relative w-full h-[280px] sm:h-[360px] lg:h-[420px] overflow-hidden rounded-xl">
                                <Image
                                    src="/Thyroid Cyst.png" // <-- apni image public me rakho
                        ...
                        <div className="lg:col-span-8">
                            <h4 className="text-[22px] sm:text-[35px] text-[30px] lg:text-[45px]  leading-tight text-slate-900">
                                What is a  {" "}
                                <span className="text-[#0b4aa2] font-extrabold">Thyroid Cyst?</span>
                            </h4>

                            <p className="mt-4 text-[16px] sm:text-[16px] leading-relaxed text-slate-700">
                                A thyroid cyst is a fluid-filled swelling inside the thyroid gland. Most thyroid cysts are benign (non-cancerous), but they can grow large and cause visible neck swelling or pressure symptoms. Unlike solid thyroid nodules which may be treated with{" "}
                                <a
                                ...
                                fluid-filled cysts respond particularly well to ethanol ablation, making it the preferred minimally invasive option for this condition.
                            </p>
                        </div>
                    </div>
                </div>
