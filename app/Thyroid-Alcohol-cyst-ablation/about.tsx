                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-8">
                            ...
                            <p className="mt-4 text-[16px] sm:text-[16px] leading-relaxed text-slate-700">
                                A thyroid cyst is a fluid-filled swelling inside the thyroid gland. Most thyroid cysts are benign (non-cancerous), but they can grow large and cause visible neck swelling or pressure symptoms.
                            </p>
                        </div>
                    </div>
                </div>
