                ...
                <div className="grid grid-cols-12 h-auto lg:h-screen items-center">
                    <div className="col-span-12 lg:col-span-5 z-10 px-5 sm:px-8 lg:px-0 pl-0 lg:pl-10 py-20 pb-0 lg:py-0">
                        <h1 className="text-[30px] sm:text-[55px] lg:text-[50px] font-extrabold leading-[1.1] text-slate-900">
                            What is Thyroid Alcohol  <br />
                            <span className="text-[#0b4aa2]">Cyst Ablation?</span>
                        </h1>
                        <p className="mt-4 text-[14px] sm:text-[18px] leading-relaxed text-slate-600 max-w-[520px]">
                            Thyroid alcohol cyst ablation, also called ethanol ablation, is a minimally invasive, image-guided procedure used to treat fluid-filled thyroid cysts. A small needle is inserted into the cyst under ultrasound guidance, the fluid is drained, and a small amount of medical alcohol is injected to shrink the cyst and prevent it from refilling — without surgery.
                        </p>
