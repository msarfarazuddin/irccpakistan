      ...
      <div className="relative mx-auto w-full pl-5 sm:pl-8  lg:pl-12 pr-0">
        <div className="grid grid-cols-12 h-auto lg:h-screen items-center">
          <div className="col-span-12 lg:col-span-5 z-10 px-5 sm:px-8 lg:px-0 pl-0 lg:pl-10 py-20 pb-0 lg:py-0">
            <h1 className="text-[30px] sm:text-[55px] lg:text-[50px] font-extrabold leading-[1.1] text-slate-900">
              Varicocele Embolization 
              <span className="text-[#0b4aa2]"> Treatment in Pakistan</span> No Surgery Needed
            </h1>
            <p className="mt-4 text-[14px] sm:text-[18px] leading-relaxed text-slate-600 max-w-[520px]">
               Varicoceles are varicose veins of the testicles and scrotum that can, but don't always, cause pain, infertility and testicular atrophy (shrinkage of the testicles). Approximately 10–15 percent of all men have varicoceles. They are most prevalent in men ages 15–35. Among infertile couples, nearly 30 percent of men have varicoceles.            </p>
            <a 
              href="#form"
              className="mt-6 inline-flex items-center justify-center shadow-xl rounded-full bg-[#0b4aa2] px-6 py-3 text-[16px] font-semibold text-white hover:opacity-95 transition-opacity"
            >
              Book Appointment
            </a>
          </div>
          ...
          <div className="col-span-12 lg:col-span-7 relative h-[320px] sm:h-[420px] lg:h-screen pr-0">
            <div className="absolute inset-0 flex items-end justify-end">
              <div className="relative w-full h-full">
                <Image
                  src="/VaricoceleEmbolization.png"
                  alt="Doctor"
                  fill
                  priority
...
export default memo(VaricoceleBanner);
