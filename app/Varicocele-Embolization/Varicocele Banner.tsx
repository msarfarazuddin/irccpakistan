        ...
        <div className="grid grid-cols-12 h-auto lg:h-screen items-center">
          <div className="col-span-12 lg:col-span-5 z-10 px-5 sm:px-8 lg:px-0 pl-0 lg:pl-10 py-20 pb-0 lg:py-0">
            <h1 className="text-[30px] sm:text-[55px] lg:text-[56px] font-extrabold leading-[1.1] text-slate-900">
              Varicocele  <br />
              <span className="text-[#0b4aa2]">Embolization</span>
            </h1>
            <p className="mt-4 text-[14px] sm:text-[18px] leading-relaxed text-slate-600 max-w-[520px]">
              Varicoceles are varicose veins of the testicles and scrotum that can, but don’t always, cause pain, infertility and testicular atrophy (shrinkage of the testicles). Approximately 10-15 percent of all men have varicoceles. They are most prevalent in men ages 15-35. Among infertile couples nearly 30 percent of men have varicoceles.
            </p>
