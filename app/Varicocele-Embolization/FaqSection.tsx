...
export default function FaqSection() {
  const faqs = useMemo<FaqItem[]>(
    () => [
      {
        q: "Is varicocele embolization painful?",
        a: "The procedure is performed under local anesthesia with a mild sedative, so you will feel little to no pain during the procedure. Some mild discomfort or dull aching may be felt for 1–2 days after, which is easily managed with over-the-counter pain medication.",
      },
      {
        q: "How long does the varicocele embolization procedure take?",
