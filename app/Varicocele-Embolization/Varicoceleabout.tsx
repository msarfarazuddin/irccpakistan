                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-8">
                            ...
                            <p className="mt-4 text-[16px] sm:text-[16px] leading-relaxed text-slate-700">
                                Varicoceles are caused when the one-way valves in the scrotal veins, which allow blood to flow from the testicles and scrotum back to the heart, become dysfunctional or fail. This causes the blood to pool and the veins around the testicle enlarge to form a varicocele. A similar mechanism of vein dysfunction is also seen in <a href="/Varicose-Vein-Ablation"> Varicose Vein Ablation</a>, where damaged vein valves cause blood to pool in the legs.
                            </p>
