        ...
        <section className="bg-white from-gray-100 to-gray-200 py-16 px-4">
            <div className="max-w-[1400px] mx-auto text-center">
                ...
                <p className="text-gray-600 max-w-4xl mx-auto mb-10 text-sm md:text-base">
                   If you prefer a minimally invasive treatment option, speak with the IRCC Pakistan team about varicocele embolization. You may be a candidate if you are an adult male and have been diagnosed with a varicocele that is causing testicular pain, discomfort, or infertility. Men experiencing vascular issues in other areas may also benefit from learning about <a href="/Peripheral-Vascular-Disease"> Peripheral Vascular Disease</a> treatment options available at IRCC Pakistan.
                </p>
            ...
            `}
                ...
                <div className="mt-12">
                     <p className="text-gray-600 max-w-4xl mx-auto mb-10 text-sm md:text-base">
                       IRCC Pakistan offers a full range of minimally invasive vascular and interventional procedures. Explore related treatments such as<a href="/Hemorrhoidal-Artery-Embolization"> Hemorrhoidal Artery Embolization</a>,<a href="/Vascular-Malformation-Treatment"> Vascular Malformation Treatment</a>, and <a href="/Interventional-Oncology">Interventional Oncology</a> services.
                    </p>
