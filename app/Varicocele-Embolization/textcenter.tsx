        ...
        <section className="bg-white from-gray-100 to-gray-200 py-16 px-4">
            <div className="max-w-[1400px] mx-auto text-center">
                ...
                <p className="text-gray-600 max-w-4xl mx-auto mb-5 text-sm md:text-base">
                    Varicocele embolization, performed by a vascular interventional radiologist, is a minimally invasive procedure that closes off blood flow to the affected veins, causing the varicocele to shrink and die off. This same embolization approach is used across several conditions at IRCC Pakistan, including <a href="/Uterine-Fibroid-Embolization"> Uterine Fibroid Embolization</a> and <a href="/Prostate-Artery-Embolization-for-Benign-Prostatic-Hyperplasia">Prostate Artery Embolization</a>.
                </p>
