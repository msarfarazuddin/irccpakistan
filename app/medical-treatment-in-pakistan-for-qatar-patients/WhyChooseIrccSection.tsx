...
const focusPoints = [
  "Specialist interventional radiology care focused on minimally invasive, image-guided procedures",
  "Case review before travel so patients can understand the proposed treatment pathway",
  "Modern imaging and procedure-based care",
  "International patient coordination for people travelling from Qatar",
  "Treatment availability in Karachi, Lahore and Islamabad",
  "Clear communication about investigations, treatment planning and follow-up",
] as const;

const profilePoints = [
  "Board-certified Interventional Radiologist",
  "Fellow in Vascular & Interventional Radiology",
  "Image-guided and minimally invasive treatment",
          ...
          <div className="grid gap-5 xl:grid-cols-[390px_minmax(0,1fr)] xl:items-start">
            <div className="rounded-[28px] border border-[#dbeafe] bg-[linear-gradient(180deg,#ffffff_0%,#f5f9ff_100%)] p-4 shadow-[0_18px_50px_rgba(15,71,91,0.05)]">
              ...
              <div className="mt-4">
                ...
                <p className="mt-3 text-[15px] leading-7 text-[#354d67]">
                  Dr. Shahbaz Ahmed Qazi is an interventional radiologist with
                  a clinical focus on image-guided, minimally invasive and
                  endovascular procedures. For international patients, the
                  first step is a review of the medical history and available
                  reports to determine whether an IRCC procedure may be
                  suitable.
                </p>
                ...
                <div className="mt-4 space-y-2">
                  {profilePoints.map((point) => (
                    <div key={point} className="flex items-start gap-2">
                      <FiCheckCircle className="mt-1 h-4 w-4 shrink-0 text-[#0e58a8]" />
                      <p className="text-[14px] leading-6 text-[#354d67]">
                        {point}
                      </p>
                    </div>
                  ))}
                ...
                >
                  View Dr. Qazi&apos;s Profile / About IRCC
                </Link>
              </div>
            </div>
            ...
            <div className="pt-1">
              ...
              <p className="mt-4 max-w-4xl text-[16px] leading-7 text-[#4a617a]">
                IRCC Pakistan provides specialist interventional radiology care
                with clear treatment planning for patients travelling from
                Qatar. The focus remains on medically appropriate,
                image-guided, minimally invasive care without unsupported
                claims.
              </p>
