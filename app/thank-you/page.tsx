...
export const metadata: Metadata = createPageMetadata({
  ...
  title: "Thank You | Appointment Confirmed - IRCC Pakistan",
  description:
    "Thank you for contacting IRCC Pakistan. Your appointment request has been received and our team will get in touch with you shortly.",
  robots: {
    index: false,
    follow: false,
  },
