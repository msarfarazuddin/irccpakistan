...
const symptoms = [
    {
        title: "Have chronic knee pain due to osteoarthritis",
        img: "/one1.png",
    },
    {
        title: "Have not improved with medications or physiotherapy",
        img: "/two2.png",
    },
    {
        title: "Want to delay or avoid knee replacement surgery",
        img: "/three.png",
    },
    {
        title: "Are not fit for major surgery",
        img: "/four.png",
    },
    {
    ...
    {
        title: "A medical evaluation and imaging are needed to confirm suitability.",
        img: "/four.png",
    },
];
        ...
        <section className="bg-white from-gray-100 to-gray-200 py-16 px-4">
            <div className="max-w-[1400px] mx-auto text-center">
                ...
                <h5 className="text-3xl text-black md:text-4xl pt-7 mb-4">
                    ...
                    <span className="text-[#0E58A8] font-bold">You may be a good candidate if you:</span>
                </h5>
