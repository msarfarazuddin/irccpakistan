                ...
                <div className="grid grid-cols-12 h-auto lg:h-screen items-center">
                    <div className="col-span-12 lg:col-span-5 z-10 px-5 sm:px-8 lg:px-0 pl-0 lg:pl-10 py-20 pb-0 lg:py-0">
                        <h1 className="text-[30px] sm:text-[55px] lg:text-[45px] font-extrabold leading-[1.1] text-slate-900">
                            Genicular Arterial    <br />
                            <span className="text-[#0b4aa2]">Embolization for Knee Pain in Pakistan</span><br></br>
                            <span> No Surgery, Faster Relief</span>
                        </h1>
                        <p className="mt-4 text-[14px] sm:text-[18px] leading-relaxed text-slate-600 max-w-[520px]">
                            At IRCC Pakistan, GAE is performed by specialist interventional radiologists using the same advanced embolization techniques used across a range of other conditions including <a href="/Uterine-Fibroid-Embolization"> Uterine Fibroid Embolization</a> and <a href="/Prostate-Artery-Embolization-for-Benign-Prostatic-Hyperplasia"> Prostate Artery Embolization</a> demonstrating the proven versatility and safety of embolization in modern medicine.
                        </p>
