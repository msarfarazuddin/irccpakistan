                ...
                <div className="grid grid-cols-12 h-auto lg:h-screen items-center">
                    <div className="col-span-12 lg:col-span-5 z-10 px-5 sm:px-8 lg:px-0 pl-0 lg:pl-10 py-20 pb-0 lg:py-0">
                        <h1 className="text-[30px] sm:text-[55px] lg:text-[50px] font-extrabold leading-[1.1] text-slate-900">
                            What is Genicular Arterial  <br />
                            <span className="text-[#0b4aa2]">Embolization (GAE) for Knee Pain?</span>
                        </h1>
                        <p className="mt-4 text-[14px] sm:text-[18px] leading-relaxed text-slate-600 max-w-[520px]">
                            Genicular Arterial Embolization (GAE) is a minimally invasive treatment for chronic knee pain, especially due to osteoarthritis. It works by reducing abnormal inflammation in the knee by blocking tiny blood vessels that contribute to pain, helping improve mobility and quality of life without major surgery.
                        </p>
