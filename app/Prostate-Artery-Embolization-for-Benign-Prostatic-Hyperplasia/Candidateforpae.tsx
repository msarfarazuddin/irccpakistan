      ...
      <div className="max-w-full mx-auto text-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-2 items-center">
          ...
          <div className="flex justify-center">
            <Image
              src="/PAE.png" // apni image public folder me rakho
        ...
        <p className="text-gray-600 max-w-4xl mx-auto mb-5 text-sm md:text-base">An exam with an interventional radiologist can determine if you are a candidate for PAE. At this appointment, you may be asked how often you experience urinary symptoms, how severe they are, and how much they affect your quality of life. For patients with prostate cancer concerns, our <a href="/Interventional-Oncology"> Interventional Oncology </a>team provides comprehensive minimally invasive cancer care.</p>
      </div>
    </section>
  );
}
