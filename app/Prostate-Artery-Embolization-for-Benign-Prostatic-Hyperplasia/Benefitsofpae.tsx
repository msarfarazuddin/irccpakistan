        ...
        <section className="bg-white from-gray-100 to-gray-200 py-16 px-4">
            ...
            `}
                ...
                <p className="text-gray-600 max-w-4xl mx-auto mt-5 text-sm md:text-base">
                    IRCC Pakistan offers a full range of minimally invasive interventional procedures. Explore related treatments such as <a href="/Hemorrhoidal-Artery-Embolization"> Hemorrhoidal Artery Embolization</a> and <a href="/Vascular-Malformation-Treatment"> Vascular Malformation Treatment</a> for comprehensive vascular care.
                </p>
