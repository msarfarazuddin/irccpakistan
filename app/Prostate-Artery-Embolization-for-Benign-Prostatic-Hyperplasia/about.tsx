                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-4">
                            <div className="relative w-full h-[280px] sm:h-[360px] lg:h-[420px] overflow-hidden rounded-xl">
                                <Image
                                    src="/What is a Prostatic.png" // <-- apni image public me rakho
                        ...
                        <div className="lg:col-span-8">
                            ...
                            <p className="mt-4 text-[16px] sm:text-[16px] leading-relaxed text-slate-700">
                                Similar embolization techniques are used at IRCC Pakistan for other conditions including <a href="/Uterine-Fibroid-Embolization"> Uterine Fibroid Embolization</a> and <a href="/Varicocele-Embolization"> Varicocele Embolization </a> demonstrating the proven effectiveness of embolization across multiple organ systems.
                            </p>
                        </div>
                    </div>
                </div>
