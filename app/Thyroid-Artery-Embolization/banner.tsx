            ...
            <div className="relative mx-auto w-full pl-5 sm:pl-8  lg:pl-12 pr-0">
                <div className="grid grid-cols-12 h-auto lg:h-screen items-center">
                    <div className="col-span-12 lg:col-span-5 z-10 px-5 sm:px-8 lg:px-0 pl-0 lg:pl-10 py-20 pb-0 lg:py-0">
                        <h1 className="text-[30px] sm:text-[55px] lg:text-[42px] font-extrabold leading-[1.1] text-slate-900">
                            Thyroid Artery Embolization  <br />
                            <span className="text-[#0b4aa2]">Non-Surgical Treatment</span>
                            <span> for Enlarged Thyroid in Pakistan</span>
                        </h1>
                        <p className="mt-4 text-[14px] sm:text-[18px] leading-relaxed text-slate-600 max-w-[520px]">
                             An interventional radiologist blocks selected thyroid arteries to reduce blood supply, which helps decrease the size of the gland or nodules and relieves pressure symptoms without open surgery. Like <a href="/Uterine-Fibroid-Embolization"> Uterine Fibroid Embolization</a> and <a href="/Varicocele-Embolization"> Varicocele Embolization</a>, TAE uses the same proven embolization technique to treat conditions by precisely cutting off blood supply to the problem area.
                        </p>
