const symptoms = [
    {
        title: "Have a large multinodular goitre or big thyroid nodules causing symptoms",
        img: "/one1.png",
    },
    {
        title: "Are not fit for surgery due to medical conditions",
        img: "/two2.png",
    },
    {
        title: "Want to avoid thyroid surgery or general anaesthesia",
        img: "/three.png",
    },
    {
        title: "Have recurrence after previous thyroid surgery",
        img: "/four.png",
    },
    {
        title: "Have compressive symptoms but benign (non-cancerous) findings on evaluation",
        img: "/five.png",
    },
    {
        title: "A detailed clinical and imaging assessment is required before treatment.",
        img: "/four.png",
    },
];
        ...
        <section className="bg-white from-gray-100 to-gray-200 py-16 px-4">
            ...
            `}
                ...
                <p className="mx-auto mt-10 max-w-5xl text-center text-sm leading-7 text-[#1f2937] md:text-lg">
                    Patients who prefer non-surgical options similar to those choosing{" "}
                    <a
                    ...
                    often find TAE to be a safe and effective alternative. A detailed clinical and imaging assessment is required before treatment.
                </p>
