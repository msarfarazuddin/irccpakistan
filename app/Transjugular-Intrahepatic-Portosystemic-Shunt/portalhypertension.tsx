            ...
            <div className="max-w-full mx-auto text-center">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-2 items-center">
                    ...
                    <div className="flex justify-center">
                        <Image
                            src="/portal hypertension.png" // apni image public folder me rakho
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <div className="bg-white shadow-lg rounded-xl p-6 max-w-xs h-55 mb-15 flex flex-col justify-center text-left relative">
                            ...
                            <p className="text-black text-sm">
                                Ascites is a buildup of fluid in the abdomen. Blood then leaks into the abdomen and causes ascites.Patients experiencing vascular complications may also benefit from our <a href="/Peripheral-Vascular-Disease"> Peripheral Vascular Disease </a> and <a href="/Vascular-Malformation-Treatment"> Vascular Malformation Treatment</a> services at IRCC Pakistan.
                            </p>
