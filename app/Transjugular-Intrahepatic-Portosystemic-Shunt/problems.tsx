  ...
  return (
    <section className="relative bg-[#0E58A8E5] py-16 px-4 overflow-hidden">
      ...
      <div className="relative max-w-[1400px] mx-auto text-center flex flex-col items-center justify-center">
        ...
        <p className=" max-w-4xl mx-auto mt-5 text-sm md:text-base">For patients with liver tumors or cancer-related complications, our <a href="/Interventional-Oncology"> Interventional Oncology </a>team provides comprehensive minimally invasive care alongside TIPS treatment.</p>
      </div>
    </section>
  );
}
