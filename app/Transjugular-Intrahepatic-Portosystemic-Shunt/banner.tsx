        ...
        <div className="grid grid-cols-12 h-auto lg:h-screen items-center">
          <div className="col-span-12 lg:col-span-6 z-10 px-5 sm:px-8 lg:px-0 pl-0 lg:pl-10 py-20 pb-0 lg:py-0">
            <h1 className="text-[30px] sm:text-[55px] lg:text-[50px] font-extrabold leading-[1.1] text-slate-900">
              <span className="text-[20px] sm:text-[40px] lg:text-[40px]">TIPS Procedure in Pakistan  </span>
              Transjugular Intrahepatic <br />
              <span className="text-[#0b4aa2]">Portosystemic Shunt Treatment</span>
            </h1>
          ...
          <div className="col-span-12 lg:col-span-6 relative h-[320px] sm:h-[420px] lg:h-screen pr-0">
            <div className="absolute inset-0 flex items-end justify-end">
              <div className="relative w-full h-full">
                <Image
                  src="/Transjugular Intrahepatic.png"
                  alt="Doctor"
                  fill
                  priority
