...
const comparisonRows = [
  {
    ...
    pakistanCost: "8,000 - 14,000",
    uaeCost: "18,000 - 25,000",
    difference: "Approx. 40% - 60% Less",
    icon: GiFemale,
  },
  {
    title: "Varicocele Embolization",
    pakistanCost: "6,000 - 9,000",
    uaeCost: "12,000 - 18,000",
    difference: "Approx. 40% - 60% Less",
    icon: GiMale,
  },
  {
    title: "Thyroid Radiofrequency Ablation (RFA)",
    pakistanCost: "7,000 - 11,000",
    uaeCost: "13,000 - 20,000",
    difference: "Approx. 40% - 60% Less",
    icon: FiActivity,
  },
  {
    title: "Varicose Vein Ablation",
    pakistanCost: "6,000 - 10,000",
    uaeCost: "12,000 - 20,000",
    difference: "Approx. 40% - 60% Less",
    icon: FiActivity,
  },
  {
    title: "Prostate Artery Embolization (PAE)",
    pakistanCost: "9,000 - 14,000",
    uaeCost: "16,000 - 24,000",
    difference: "Approx. 40% - 60% Less",
    icon: FiHeart,
  },
] as const;
