...
const focusPoints = [
  ...
  "Care across major cities in Pakistan",
] as const;
          ...
          <div className="grid gap-5 xl:grid-cols-[390px_minmax(0,1fr)] xl:items-start">
            <div className="rounded-[28px] border border-[#dbeafe] bg-[linear-gradient(180deg,#ffffff_0%,#f5f9ff_100%)] p-4 shadow-[0_18px_50px_rgba(15,71,91,0.05)]">
              ...
              <div className="mt-4">
                ...
                <p className="mt-3 text-[15px] leading-7 text-[#354d67]">
                  Dr. Shahbaz Ahmed Qazi is a foreign-trained vascular and
                  interventional radiologist whose practice focuses on
                  minimally invasive, image-guided procedures.
                </p>
                <p className="mt-2.5 text-[15px] leading-7 text-[#354d67]">
                  His areas of expertise highlighted by IRCC include
                  radiofrequency ablation, thyroid procedures and varicocele
                  embolization.
                </p>
            ...
            <div className="pt-1">
              ...
              <p className="mt-4 max-w-4xl text-[16px] leading-7 text-[#4a617a]">
                IRCC Pakistan focuses on image-guided and minimally invasive
                interventional radiology procedures. The centre&apos;s current
                website highlights Dr. Shahbaz Ahmed Qazi and a broad portfolio
