                ...
                <div className="grid grid-cols-12 h-auto lg:h-screen items-center">
                    <div className="col-span-12 lg:col-span-5 z-10 px-5 sm:px-8 lg:px-0 pl-0 lg:pl-10 py-20 pb-0 lg:py-0">
                        <h1 className="text-[30px] sm:text-[55px] lg:text-[50px] font-extrabold leading-[1.1] text-slate-900">
                            What is the Role of Interventional Radiology  <br />
                            <span className="text-[#0b4aa2]">in Tenosynovitis Treatment?</span>
                        </h1>
                        <p className="mt-4 text-[14px] sm:text-[18px] leading-relaxed text-slate-600 max-w-[520px]">
                            Interventional Radiology (IR) provides minimally invasive, image-guided treatments for tenosynovitis. Using embolization procedures, interventional radiolgist can deliver precise anti-inflammatory medications or other targeted therapies around the affected tendon sheath to reduce swelling, relieve pain, and improve movement — without surgery.
                        </p>
