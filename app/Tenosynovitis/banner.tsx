                ...
                <div className="grid grid-cols-12 h-auto lg:h-screen items-center">
                    <div className="col-span-12 lg:col-span-5 z-10 px-5 sm:px-8 lg:px-0 pl-0 lg:pl-10 py-20 pb-0 lg:py-0">
                        <h1 className="text-[30px] sm:text-[55px] lg:text-[42px] font-extrabold leading-[1.1] text-slate-900">
                            Tenosynovitis Treatment  <br />
                            <span className="text-[#0b4aa2]">Without Surgery — Interventional </span>Radiology in Pakistan
                        </h1>
                        <p className="mt-4 text-[14px] sm:text-[18px] leading-relaxed text-slate-600 max-w-[520px]">
                            Interventional Radiology (IR) provides minimally invasive, image-guided treatments for tenosynovitis. This approach is part of IRCC Pakistan's broader expertise in musculoskeletal pain management, which also includes <a href="Plantar-Fasciitis"> Plantar Fasciitis Treatment</a> and <a href="/Genicular-Arterial-Embolization-for-Knee-Pain"> Genicular Arterial Embolization for Knee Pain </a>all using the same precise, image-guided embolization technique.
                        </p>
                    ...
                    <div className="col-span-12 lg:col-span-7 relative h-[320px] sm:h-[420px] lg:h-screen pr-0">
                        <div className="absolute inset-0 flex items-end justify-end">
                            <div className="relative w-full h-full">
                                <Image
                                    src="/Tenosynovitis Treatment.png"
                                    alt="Doctor"
                                    fill
                                    priority
