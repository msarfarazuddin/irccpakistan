                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-8">
                            ...
                            <p className="mt-4 text-[16px] sm:text-[16px] leading-relaxed text-slate-700">
                                Tenosynovitis is inflammation of the fluid-filled sheath (synovium) that surrounds a tendon. It commonly affects the wrist, hand, ankle, or foot and can result from overuse, injury, or underlying inflammatory conditions.
                            </p>
                        </div>
                    </div>
                </div>
