                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-4">
                            <div className="relative w-full h-[280px] sm:h-[360px] lg:h-[420px] overflow-hidden rounded-xl">
                                <Image
                                    src="/Tenosynovitis.png" // <-- apni image public me rakho
                        ...
                        <div className="lg:col-span-8">
                            <h4 className="text-[22px] sm:text-[35px] text-[30px] lg:text-[45px]  leading-tight text-slate-900">
                                What is  {" "}
                                <span className="text-[#0b4aa2] font-extrabold">Tenosynovitis?</span>
                            </h4>

                            <p className="mt-4 text-[16px] sm:text-[16px] leading-relaxed text-slate-700">
                                Tenosynovitis is inflammation of the fluid-filled sheath (synovium) that surrounds a tendon. It commonly affects the wrist, hand, ankle, or foot and can result from overuse, injury, or underlying inflammatory conditions. In chronic cases where conservative treatment fails, minimally invasive IR-based options offer a proven path to lasting relief similar to how{" "}
                                <a
                                ...
                                addresses chronic bone pain non-surgically.
                            </p>
                        </div>
                    </div>
                </div>
