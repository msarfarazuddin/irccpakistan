        ...
        <section className="bg-white from-gray-100 to-gray-200 py-16 px-4">
            ...
            `}
                ...
                <p className="text-gray-600 max-w-4xl mx-auto mt-20 text-sm md:text-base">
                    People with Coronary Artery Disease (CAD) frequently also have PVD, as both conditions share the same underlying mechanism of arterial plaque buildup.
                    Patients with vascular conditions affecting circulation may also be at risk for complications related to{" "}
                    <Link
                    ...
                    if portal hypertension is involved, or may benefit from evaluation for{" "}
                    <Link
                    ...
                    if structural vascular abnormalities are suspected.
                </p>
