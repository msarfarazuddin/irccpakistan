...
export default function Footer() {
  ...
  const cityLinks = [
    { label: "KARACHI", href: "/minimally-invasive-treatment-karachi" },
    { label: "LAHORE", href: "/interventional-radiology-lahore" },
    { label: "ISLAMABAD", href: "/non-surgical-treatment-islamabad" },
  ];
  ...
  return (
    <footer className="relative border-t border-[#BFDBEA] bg-[#ffffff]">
      ...
      <div className="relative mx-auto max-w-full px-4 py-10 pb-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-3 md:items-start lg:grid-cols-[1.15fr_1.15fr_1fr]">
          ...
          <div className="z-30 md:justify-self-center lg:w-full">
            <div className="grid gap-8 lg:grid-cols-2 lg:gap-10">
                ...
                <ul className="mt-4 space-y-2">
                  {quickLinks.map((l) => (
                    <li key={l.href}>
                      <Link
                        href={l.href}
                        className="text-sm font-medium uppercase text-[#0B1B2B] hover:text-[#0E58A8] hover:underline underline-offset-4"
                      >
                        {l.label}
                      </Link>
                    </li>
              ...
              <div>
                <h4 className="text-[20px] font-semibold text-[#0E58A8]">Cities</h4>
                <ul className="mt-4 space-y-2">
                  {cityLinks.map((l) => (
                    <li key={l.href}>
                      <Link
        ...
        <div className="mt-8 flex flex-col gap-4 border-t border-[#E4F0FF] pt-6 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-3">
            ...
            <SocialIcon href="https://www.tiktok.com/@drshahbazqazi" label="TikTok">
              <TikTokIcon />
            </SocialIcon>
            <SocialIcon href="https://www.snapchat.com/add/irccpakistan" label="Snapchat">
              <SnapchatIcon />
            </SocialIcon>
