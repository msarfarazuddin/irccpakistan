...
export default function WhyChooseSection() {
    const cards: ChooseCard[] = [
        ...
        },
        {
            ...
            desc: "we are specialized in a wide array of musculoskeletal interventional radiology services.",
            icon: <MSKIcon />,
            href: "https://api.whatsapp.com/send/?phone=923340005020&text&type=phone_number&app_absent=0",
        },
        {
            title: "Pain Management",
            desc: "Our Pain management specialists are trained in leading institutions worldwide, ensuring top-notch care.",
            icon: <PleuralIcon />,
            href: "https://api.whatsapp.com/send/?phone=923340005020&text&type=phone_number&app_absent=0",
        },
    ];
