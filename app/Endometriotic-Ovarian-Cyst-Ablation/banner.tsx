                ...
                <div className="grid grid-cols-12 h-auto lg:h-screen items-center">
                    <div className="col-span-12 lg:col-span-5 z-10 px-5 sm:px-8 lg:px-0 pl-0 lg:pl-10 py-20 pb-0 lg:py-0">
                        <h1 className="text-[30px] sm:text-[55px] lg:text-[50px] font-extrabold leading-[1.1] text-slate-900">
                            Endometriotic Ovarian <br />
                            <span className="text-[#0b4aa2]">Cyst Ablation in Pakistan</span><br></br>
                            <span className="text-[20px] sm:text-[40px] lg:text-[40px]">Minimally Invasive Treatment for Chocolate Cysts</span>
                        </h1>
                        <p className="mt-4 text-[14px] sm:text-[18px] leading-relaxed text-slate-600 max-w-[520px]">
                            Endometriotic ovarian cyst ablation is a minimally invasive, image-guided treatment used to shrink or destroy ovarian cysts caused by endometriosis. A interventional radiologist inserts a fine needle into the cyst using ultrasound and treats it without major surgery, helping relieve pain while preserving healthy ovarian tissue.
                        </p>
