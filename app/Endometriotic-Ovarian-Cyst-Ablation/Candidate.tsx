...
const symptoms = [
    {
        title: "Have a confirmed endometriotic cyst",
        img: "/one1.png",
    },
    {
        title: "Have ongoing pelvic pain",
        img: "/two2.png",
    },
    {
        title: "Did not improve with medicines",
        img: "/three.png",
    },
    {
        title: "Want to avoid major surgery",
        img: "/four.png",
    },
    {
        title: "Wish to preserve fertility",
        img: "/five.png",
    },
    {
        title: "Have recurrence after previous surgery",
        img: "/four.png",
    },
];
        ...
        <section className="bg-white from-gray-100 to-gray-200 py-16 px-4">
            <div className="max-w-[1400px] mx-auto text-center">
                ...
                <h5 className="text-3xl text-black md:text-4xl pt-7 mb-4">
                    Who is a Candidate for Cyst Ablation? {" "}
