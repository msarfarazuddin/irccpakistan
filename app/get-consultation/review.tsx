...
export default function VideoReviewSection() {
  ...
  const videos: VideoItem[] = useMemo(
    () => [
      {
        id: "1",
        videoUrl: "https://www.youtube.com/embed/qFDwUZ99NSk?rel=0&modestbranding=1",
        thumb: "https://i.ytimg.com/vi/qFDwUZ99NSk/hqdefault.jpg",
      },
      {
        id: "2",
        videoUrl: "https://www.youtube.com/embed/K4lPZOTX5GM?rel=0&modestbranding=1",
        thumb: "https://i.ytimg.com/vi/K4lPZOTX5GM/hqdefault.jpg",
      },
      {
        id: "3",
        videoUrl: "https://www.youtube.com/embed/89-PGNg8Sgg?rel=0&modestbranding=1",
        thumb: "https://i.ytimg.com/vi/89-PGNg8Sgg/hqdefault.jpg",
      },
      {
        id: "4",
        videoUrl: "https://www.youtube.com/embed/d4TDP43c4a4?rel=0&modestbranding=1",
        thumb: "https://i.ytimg.com/vi/d4TDP43c4a4/hqdefault.jpg",
      },
      {
        id: "5",
        videoUrl: "https://www.youtube.com/embed/XUAGNdxROB8?rel=0&modestbranding=1",
        thumb: "https://i.ytimg.com/vi/XUAGNdxROB8/hqdefault.jpg",
      },
      {
        id: "6",
        videoUrl: "https://www.youtube.com/embed/cFBSVqDPa8k?rel=0&modestbranding=1",
        thumb: "https://i.ytimg.com/vi/cFBSVqDPa8k/hqdefault.jpg",
      },
    ],
    []
  );
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:items-center">
          ...
          <div className="pt-2">
            <div className="text-lg font-semibold text-gray-900 sm:text-xl">
              ...
              <span className="ml-1 italic text-[#1e76bd]">{reviews[activeReview].role}</span>
            </div>
