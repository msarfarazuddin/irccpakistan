...
export default function FemaleClinicForm() {
  ...
  return (
    <section className="relative w-full min-h-[100svh] overflow-x-hidden bg-[#0b3d5a]">
      ...
      <div className="relative mx-auto flex w-full max-w-[1400px] flex-col px-4 pb-8 pt-6 lg:min-h-[100svh] lg:pb-10 lg:pt-8">
        ...
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="flex items-start gap-2 md:gap-4">
            ...
            >
              <span className="grid h-9 w-9 place-items-center rounded-full bg-white/20 text-[#0E58A8] md:text-white">
                {/* phone icon */}
              ...
              <span className="hidden text-sm font-semibold md:inline">92-3340005020</span>
            </a>
            ...
            >
              ...
              <span className="hidden text-sm font-semibold md:inline">irccpakistan@gmail.com</span>
            </a>
          </div>
        </div>

        {/* Main grid */}
        <div className="mt-8 grid items-start gap-8 lg:mt-auto lg:grid-cols-[1.25fr_0.9fr] lg:items-end lg:pt-10">
          {/* Left content */}
          <div className="text-white">
            ...
            <p className="mt-4 max-w-[720px] text-sm leading-relaxed text-white sm:text-base">
            ...
            {/* Features icons */}
            <div className="mt-8 grid max-w-[760px] grid-cols-2 gap-4 md:grid-cols-4">
            ...
            className="w-full rounded-2xl border-2 border-[#dadbdd] bg-white px-5 py-4 text-[16px] text-black placeholder:text-black/70 outline-none resize-y focus:border-[#dadbdd]"
                ...
                <div className="pt-2 text-center">
                  <button
                    ...
                    className="inline-flex rounded-2xl border border-[#1e76bd] bg-gradient-to-r from-[#1e76bd] to-[#1e76bd] px-5 py-2 text-base font-bold text-white shadow-md transition hover:brightness-110 disabled:opacity-70 sm:text-lg"
                  >
    ...
    <div className="flex flex-col items-center gap-3 text-center">
      <div className="grid h-[86px] w-[106px] place-items-center rounded-bl-none rounded-br-[24px] rounded-tl-[24px] rounded-tr-none bg-[#f1f3f5] shadow-[0_10px_20px_rgba(0,0,0,0.14)] sm:h-[92px] sm:w-[114px]">
        <div className="relative h-[52px] w-[52px] sm:h-[56px] sm:w-[56px]">
          <Image src={imageSrc} alt={title} fill sizes="56px" className="object-contain" />
        </div>
      </div>
