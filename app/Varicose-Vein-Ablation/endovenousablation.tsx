    ...
    <section className="bg-[#ffffff] py-16 px-4 bg-center bg-no-repeat" style={{ backgroundImage: "url('/faq.png')" }}>
      <div className="max-w-full mx-auto  text-center">
        ...
        <p className="text-gray-600 lg:pl-30  lg:pr-30 sm:pl-2 sm:pr-2 mb-2">
          Radiofrequency Ablation (RFA), Endovenous Laser Therapy (EVLT), and non-thermal non-tumescent ablation are safe, effective, minimally invasive procedures for the treatment of varicose veins. Thermal energy is used to close off a blood vessel using either laser or radiofrequency energy. The failing vein closes, is no longer functional, and is eventually absorbed by the body. This same radiofrequency ablation technology is also used at IRCC Pakistan for <a href="/Thyroid-Radiofrequency-Ablation"> Thyroid Radiofrequency Ablation</a> and <a href="/Radiofrequency-Ablation-of-Osteoid-Osteoma"> Radiofrequency Ablation of Osteoid Osteoma</a>.
        </p>
