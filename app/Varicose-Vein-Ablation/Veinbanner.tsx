      ...
      <div className="relative mx-auto w-full pl-5 sm:pl-8  lg:pl-12 pr-0">
        <div className="grid grid-cols-12 h-auto lg:h-screen items-center">
          <div className="col-span-12 lg:col-span-5 z-10 px-5 sm:px-8 lg:px-0 pl-0 lg:pl-10 py-20 pb-0 lg:py-0">
            ...
            <h1 className="text-[30px] sm:text-[55px] lg:text-[45px] font-extrabold leading-[1.1] text-slate-900"> Varicose Vein Ablation  <br /><span className="text-[#0b4aa2]"> Treatment in Pakistan </span>Minimally Invasive & Scarless</h1>
            <p className="mt-4 text-[14px] sm:text-[18px] leading-relaxed text-slate-600 max-w-[520px]">
              Varicose veins are swollen, twisted, abnormal veins primarily found in the legs.
               The vein specialists at IRCC Pakistan have treated hundreds of patients nationwide who are suffering from painful varicose veins. Similar minimally invasive embolization techniques are also used at IRCC Pakistan for conditions like <a href="/Varicocele-Embolization" > Varicocele Embolization</a> and <a href="/Hemorrhoidal-Artery-Embolization" > Hemorrhoidal Artery Embolization</a>.
            </p>
