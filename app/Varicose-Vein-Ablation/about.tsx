                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-4">
                            <div className="relative w-full h-[280px] sm:h-[360px] lg:h-[420px] overflow-hidden rounded-xl">
                                <Image
                                    src="/Varicose Vein.png" // <-- apni image public me rakho
                        ...
                        <div className="lg:col-span-8">
                            ...
                            <p className="mt-4 text-[16px] sm:text-[16px] leading-relaxed text-slate-700">
                                Varicose veins are caused by unhealthy or weakened valves inside the veins. Vein valves can become damaged from natural stretching or weakening from the pressure of blood flowing through the veins. If the valves become weak, blood can collect in your legs and pressure builds up, causing the veins to become large, twisted and weak. Varicose veins often appear through the skin on a person's legs as blue, bulging and twisted veins  in some cases the veins may be raised or stand out on the surface of the skin. A related vascular condition caused by similar blood flow disruption is <a href="/Pelvic-Congestion-Syndrome-Treatment">Peripheral Vascular Disease</a>, which can also affect circulation in the legs.
                            </p>
