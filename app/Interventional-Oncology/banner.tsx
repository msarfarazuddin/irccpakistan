                ...
                <div className="grid grid-cols-12 h-auto lg:h-screen items-center">
                    <div className="col-span-12 lg:col-span-6 z-10 px-5 sm:px-8 lg:px-0 pl-0 lg:pl-10 py-20 pb-0 lg:py-0">
                        <h1 className="text-[30px] sm:text-[55px] lg:text-[45px] font-extrabold leading-[1.1] text-slate-900">
                            Interventional Oncology Minimally 
                            <span className="text-[#0b4aa2]"> Invasive Cancer Treatment in Pakistan</span>
                        </h1>
                        <p className="mt-4 text-[14px] sm:text-[18px] leading-relaxed text-slate-600 max-w-full">
                            Interventional radiology is a critical component of diagnosing and treating many types of cancer and cancer-related complications. Interventional radiology procedures provide targeted, minimally invasive therapies – particularly for cancers that cannot be treated with surgery or chemotherapy to the entire body.
                        </p>

                        <a
                            href="#form"
                            className="mt-6 inline-flex items-center justify-center rounded-full bg-[#0b4aa2] px-6 py-3 text-[16px] font-semibold text-white shadow-xl hover:opacity-95"
                        >
                            Book an appointment
                        </a>
                    </div>
                    ...
                    <div className="col-span-12 lg:col-span-6 relative h-[320px] sm:h-[420px] lg:h-screen pr-0">
                        <div className="absolute inset-0 flex items-end justify-end">
                            <div className="relative w-full h-full">
                                <Image
                                    src="/Interventional Oncology.png"
                                    alt="Doctor"
                                    fill
                                    priority
