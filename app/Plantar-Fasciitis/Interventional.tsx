                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-12">
                            ...
                            <p className="mt-4 text-[16px] sm:text-[16px] leading-relaxed text-slate-700">
                                At IRCC Pakistan, our Interventional Radiology team provides safe, precise, and non-surgical treatment for planter fasciitis using embolization. The procedure involves minimal pain, no stitches, quick recovery, and excellent cosmetic results, helping you return to normal activities quickly.
                            </p>
                        </div>
                    </div>
                </div>
