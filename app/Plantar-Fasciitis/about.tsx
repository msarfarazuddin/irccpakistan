                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-8">
                            ...
                            <p className="mt-4 text-[16px] sm:text-[16px] leading-relaxed text-slate-700">
                                Plantar fasciitis is a common condition caused by inflammation of the plantar fascia, a thick band of tissue that runs along the bottom of the foot and supports the arch. It is one of the most frequent causes of heel pain, especially in adults who stand or walk for long hours.
                            </p>
                        </div>
                    </div>
                </div>
