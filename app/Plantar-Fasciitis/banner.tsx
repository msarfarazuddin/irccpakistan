                ...
                <div className="grid grid-cols-12 h-auto lg:h-screen items-center">
                    <div className="col-span-12 lg:col-span-5 z-10 px-5 sm:px-8 lg:px-0 pl-0 lg:pl-10 py-20 pb-0 lg:py-0">
                        <h1 className="text-[30px] sm:text-[55px] lg:text-[50px] font-extrabold leading-[1.1] text-slate-900">
                            ...
                            <span className="text-[#0b4aa2]">Interventional Radiology in Plantar Fasciitis?</span>
                        </h1>
                        <p className="mt-4 text-[14px] sm:text-[18px] leading-relaxed text-slate-600 max-w-[520px]">
                            Interventional Radiology (IR) offers minimally invasive, image-guided treatments for chronic plantar fasciitis that does not improve with rest, medication, or physiotherapy. Using embolization under fluoroscopy angiography guidance, interventional radiologist can perform targeted procedures to reduce inflammation and promote healing — helping relieve heel pain without surgery.
                        </p>
