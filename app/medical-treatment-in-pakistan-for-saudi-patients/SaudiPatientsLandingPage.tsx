...
import CostComparisonSection from "@/app/medical-treatment-in-pakistan-for-saudi-patients/CostComparisonSection";
import FinalCtaSection from "@/app/medical-treatment-in-pakistan-for-saudi-patients/FinalCtaSection";
import ForPatientsInSection from "@/app/medical-treatment-in-pakistan-for-saudi-patients/ForPatientsInSection";
import LocationsFaqSection from "@/app/medical-treatment-in-pakistan-for-saudi-patients/LocationsFaqSection";
import PatientJourneySection from "@/app/medical-treatment-in-pakistan-for-saudi-patients/PatientJourneySection";
import SaudiServicesSection from "@/app/medical-treatment-in-pakistan-for-saudi-patients/SaudiServicesSection";
import WhyChooseIrccSection from "@/app/medical-treatment-in-pakistan-for-saudi-patients/WhyChooseIrccSection";
...
const highlights = [
  ...
  {
    title: "Minimally invasive treatment options",
    icon: FiActivity,
  },
  {
    title: "Treatment planning before travel",
    icon: FiShield,
  },
  {
    title: "Patients from Saudi Arabia welcome",
    icon: FiMessageCircle,
  },
  {
    title: "Treatment locations in Karachi, Lahore and Islamabad",
    icon: FiMapPin,
  },
] as const;
...
export default function SaudiPatientsLandingPage() {
    ...
    try {
      const response = await fetch("/api/consultation", {
        ...
        body: JSON.stringify({
          ...
          city: form.city.trim(),
          conditionConcern: form.conditionTreatment.trim(),
    ...
    <>
      <section className="relative -mt-[72px] overflow-hidden bg-[#f3f8fb] pb-10 pt-[88px] text-[#0b1320] [font-family:var(--font-neue-montreal),var(--font-geist-sans),Arial,Helvetica,sans-serif] sm:pb-12 sm:pt-[92px] lg:pb-14 lg:pt-[96px]">
        <div className="absolute inset-0">
          <Image
            src="/saudi city.jpg"
            alt="Medical treatment in Pakistan for Saudi patients"
            fill
            priority
          ...
          <div className="grid w-full gap-6 lg:grid-cols-[minmax(0,1.08fr)_460px] lg:items-center xl:gap-5">
            <div className="min-w-0 p-4 sm:p-7 lg:max-w-[920px] lg:p-8 lg:pt-0">
              <h1 className="mt-4 max-w-[18ch] text-[34px] font-normal leading-[1.02] text-[#091223] sm:text-5xl lg:text-[55px] xl:text-[55px]">
                ...
                <span className="text-[#0e58a8]">Saudi Patients</span>
              </h1>
              ...
              <div className="mt-4 max-w-[68ch] space-y-3 text-[15px] leading-7 text-[#30465f] sm:text-base sm:leading-7 lg:text-[16px] lg:leading-7">
                <p>
                  Patients living in Saudi Arabia can explore specialist
                  treatment options in Pakistan after a clinical review of
                  their medical condition. IRCC Pakistan provides image-guided,
                  minimally invasive procedures for selected vascular,
                  women&apos;s health, thyroid, prostate, musculoskeletal and
                  oncology conditions.
                </p>
                <p className="max-w-[60ch]">
                  If you are considering treatment in Pakistan, share your
                  medical reports with the IRCC team before making travel
                  arrangements. The appropriate treatment, location and next
                  steps depend on your individual case.
                </p>
              </div>
            ...
            >
              <h2 className="text-[25px] font-medium leading-tight">
                Start Your Consultation from Saudi Arabia
              </h2>
              ...
              <form className="mt-6 space-y-3.5" onSubmit={onSubmit}>
                ...
                >
                  <option value="">City in Saudi Arabia</option>
                ...
                <textarea
                  ...
                  placeholder="Condition / Treatment Needed"
                  className="w-full rounded-[18px] border border-white/35 bg-white px-4 py-3 text-[#0b1320] outline-none transition placeholder:text-[#5e6b7d] focus:border-[#93c5fd] focus:ring-2 focus:ring-[#93c5fd]/40"
                />
                ...
                >
                  {status === "loading" ? "Sending..." : "Get a Treatment Assessment"}
                  <FiArrowUpRight className="h-5 w-5" />
                </button>
