        ...
        <section className="bg-white from-gray-100 to-gray-200 py-16 px-4">
            <div className="max-w-[1400px] mx-auto text-center">
                ...
                <p className="text-gray-600 max-w-4xl mx-auto mb-5 text-sm md:text-base">
                    If you have been diagnosed with blockages in your fallopian tubes and/or have a history of infertility, endometriosis, or are suffering from painful intercourse, you may be a candidate for fallopian tube recanalization.
                    <br></br>
                    Before deciding on treatment, speak to your IRCC team about all available options as well as your full symptom history including pelvic inflammatory disease, uterine fibroids, tubal or ovarian abscesses, and other pelvic conditions. Women dealing with uterine fibroids alongside fallopian tube issues may also want to learn about <a href="/Uterine-Fibroid-Embolization"> Uterine Fibroid Embolization</a> as a complementary treatment option.
                </p>
