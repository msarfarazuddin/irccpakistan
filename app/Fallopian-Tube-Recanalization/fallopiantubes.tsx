                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-4">
                            <div className="relative w-full h-[280px] sm:h-[360px] lg:h-[420px] overflow-hidden rounded-xl">
                                <Image
                                    src="/fallopian tubes.png" // <-- apni image public me rakho
                                    alt="Uterine Fibroid Embolization Patient"
                                    fill sizes="(max-width: 640px) 100vw, (max-width: 1024px) 33.33vw, 33.33vw" className="object-contain object-bottom"
                                    priority
                                />
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-8">
                            ...
                            <p className="mt-4 text-[16px] sm:text-[16px] leading-relaxed text-slate-700">
                                A common cause of female infertility is a blockage of the fallopian tubes, usually as the result of debris that has built up. Occasionally, scarring from surgery or serious infection — such as pelvic inflammatory disease can lead to a blockage as well. Women with a history of <a href="/Pelvic-Congestion-Syndrome-Treatment"> Pelvic Congestion Syndrome</a> or uterine fibroids are also at higher risk of developing fallopian tube blockages.
                            </p>
                        </div>
                    </div>
                </div>
