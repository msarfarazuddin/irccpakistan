...
export default function Fallopianbanner() {
    return (
            ...
            <div className="relative mx-auto w-full pl-5 sm:pl-8  lg:pl-12 pr-0">
                <div className="grid grid-cols-12 h-auto lg:h-screen items-center">
                    <div className="col-span-12 lg:col-span-5 z-10 px-5 sm:px-8 lg:px-0 pl-0 lg:pl-10 py-20 pb-0 lg:py-0">
                        <h1 className="text-[30px] sm:text-[50px] lg:text-[45px] font-extrabold leading-[1.1] text-slate-900">
                            Fallopian Tube Recanalization<br />
                            <span className="text-[#0b4aa2]">in Pakistan Restore Fertility Without Surgery</span>
                        </h1>
                        <h3 className="text-[20px] text-black">What is fallopian tube recanalization?</h3>
                        <p className="mt-4 text-[14px] sm:text-[18px] leading-relaxed text-slate-600 max-w-[520px]">
                            Fallopian tube recanalization (FTR) is a nonsurgical procedure to clear blockages in the fallopian tubes, Women experiencing reproductive health issues may also benefit from exploring related conditions such as <a href="/Uterine-Fibroid-Embolization"> Uterine Fibroid Embolization</a> and <a href="/Endometriotic-Ovarian-Cyst-Ablation"> Endometriotic Ovarian Cyst Ablation</a>, which can also affect fertility.
                        </p>
                    ...
                    <div className="col-span-12 lg:col-span-7 relative h-[320px] sm:h-[420px] lg:h-screen pr-0">
                        <div className="absolute inset-0 flex items-end justify-end">
                            <div className="relative w-full h-full">
                                <Image
                                    src="/Fallopian Tube.png"
                                    alt="Doctor"
                                    fill
                                    priority
                                    sizes="(max-width: 640px) 100vw, (max-width: 1024px) 58.33vw, 58.33vw"
