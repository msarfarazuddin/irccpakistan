        ...
        <section className="bg-white from-gray-100 to-gray-200 py-16 px-4">
            ...
            `}
                ...
                <p className="text-gray-600 max-w-4xl mx-auto mt-5 text-sm md:text-base">
                    IRCC Pakistan also offers a full range of women's health interventional procedures including <a href="/Pelvic-Congestion-Syndrome-Treatment"> Pelvic Congestion Syndrome Treatment</a> and <a href="/Endometriotic-Ovarian-Cyst-Ablation"> Endometriotic Ovarian Cyst Ablation</a> for comprehensive reproductive care.
                </p>
