                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-4">
                            <div className="relative w-full h-[280px] sm:h-[360px] lg:h-[420px] overflow-hidden rounded-xl">
                                <Image
                                    src="/Thyroid Ablation.png" // <-- apni image public me rakho
                        ...
                        <div className="lg:col-span-8">
                            ...
                            <p className="mt-4 text-[16px] sm:text-[16px] leading-relaxed text-slate-700">
                                The procedure is carried out with the patient awake and the area is anaesthetised with local anaesthetic all the patient feels is mild pushing in the neck. The procedure takes 20–40 minutes depending on the size of the nodule. Maximum reduction in nodule size is achieved at 6 months.
                            </p>
                            <p className="mt-4 text-[16px] sm:text-[16px] leading-relaxed text-slate-700">
                                The same radiofrequency ablation technology is also used at IRCC Pakistan for <a href="/Radiofrequency-Ablation-of-Osteoid-Osteoma"> Radiofrequency Ablation of Osteoid Osteoma</a> and <a href="/Varicose-Vein-Ablation"> Varicose Vein Ablation</a>  demonstrating its versatility across multiple conditions.
                            </p>
                        </div>
                    </div>
                </div>
