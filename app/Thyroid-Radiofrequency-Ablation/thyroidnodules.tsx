            ...
            <div className="max-w-full mx-auto text-center ">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-2 items-center">
                    ...
                    <div className="flex justify-center">
                        <Image
                            src="/thyroid nodules.png" // apni image public folder me rakho
                ...
                <p className="text-gray-600 max-w-4xl mx-auto mb-5 text-sm md:text-base">For patients with thyroid cysts rather than solid nodules, IRCC Pakistan also offers <a href="/Thyroid-Alcohol-cyst-ablation"> Thyroid Alcohol Cyst Ablation</a> as an alternative minimally invasive option. Additionally, patients with thyroid conditions affecting blood supply may benefit from <a href="/Thyroid-Artery-Embolization">  Thyroid Artery Embolization</a>.</p>
