...
const symptoms: Symptom[] = [
    ...
    },
    {
        title: (
            <>
                Thrombolysis is a safe, highly effective way of re-establishing circulation blocked by a clot. Venous blood flow problems are also seen in conditions like{" "}
                <Link
                    href="/Pelvic-Congestion-Syndrome-Treatment"
                    className="underline underline-offset-4 transition hover:text-[#d7e9ff]"
                >
                    Pelvic Congestion Syndrome
                </Link>
                , where similar catheter-based techniques are used.
            </>
        ),
        img: "/two2.png",
    },
            ...
            `}
                            >
                                ...
                                <div className="relative w-full h-48 rounded-lg overflow-hidden">
                                    <Image
                                        src={item.img}
                                        alt={typeof item.title === "string" ? item.title : "Catheter-directed thrombolysis benefit"}
                                        fill
