        ...
        <section className="bg-white py-16 px-4">
            <div className="max-w-[1400px] mx-auto text-center items-center flex flex-col">
                ...
                <p className="text-gray-600 max-w-4xl mx-auto mb-10 text-sm md:text-base">
                    Dialysis fistula/graft declotting and interventions are minimally invasive procedures performed to improve or restore blood flow in the fistula and graft placed in the blood vessels of dialysis patients. Patients with abnormal vessel anatomy may also benefit from{" "}
                    <Link
                    ...
                    alongside their dialysis access care.
                </p>
