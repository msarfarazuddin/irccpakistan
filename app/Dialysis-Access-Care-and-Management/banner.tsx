            ...
            <div className="relative mx-auto w-full pl-5 sm:pl-8  lg:pl-12 pr-0">
                <div className="grid grid-cols-12 h-auto lg:h-screen items-center">
                    <div className="col-span-12 lg:col-span-5 z-10 px-5 sm:px-8 lg:px-0 pl-0 lg:pl-10 py-20 pb-0 lg:py-0">
                        <h1 className="text-[30px] sm:text-[55px] lg:text-[56px] font-extrabold leading-[1.1] text-slate-900">
                           Dialysis Access Care <br />
                            <span className="text-[#0b4aa2]">and Management</span>
                        </h1>
                        <h3 className="text-[20px] text-black">What is Dialysis?</h3>
                        <p className="mt-4 text-[14px] sm:text-[18px] leading-relaxed text-slate-600 max-w-full">
Dialysis allows people with kidney failure (renal failure) a chance to live productive lives. When kidney function decreases to a critical level or complications arise, a person may need to start dialysis. There are two main types of dialysis, hemodialysis and peritoneal dialysis. Patients with underlying <a href="/Peripheral-Vascular-Disease"> Peripheral Vascular Disease</a> are at higher risk of kidney complications that may require dialysis.
                        </p>
