...
const embolization = [
    {
        title: "Success rates of 90%.",
        img: "/one1.png",
    },
    {
        title: "Quicker recovery time",
        img: "/two2.png",
    },
        ...
        <section className="relative  bg-[#0E58A8E5] from-gray-100 to-gray-200 py-16  px-4"  >
            ...
            <div className="relative  max-w-[1400px] mx-auto text-center">
                ...
                <h5 className="text-3xl text-white md:text-4xl pt-7 mb-4">
                    What are the
                    <span className="text-white font-bold"> benefits of ovarian vein</span> embolization?
                </h5>
            ...
            `}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
                    {embolization.map((item, index) => {
                        const isSecondLast = index === embolization.length - 2;
                        const isLast = index === embolization.length - 1;
