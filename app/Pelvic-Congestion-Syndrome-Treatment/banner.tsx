        ...
        <div className="grid grid-cols-12 h-auto lg:h-screen items-center">
          <div className="col-span-12 lg:col-span-6 z-10 px-5 sm:px-8 lg:px-0 pl-0 lg:pl-10 py-20 pb-0 lg:py-0">
            <h1 className="text-[30px] sm:text-[55px] lg:text-[45px] font-extrabold leading-[1.1] text-slate-900">
              Minimally Invasive Ovarian <br />
              <span className="text-[#0b4aa2]">Vein Embolization — No Surgery,</span> No Overnight Stay
            </h1>
            <h3 className="text-black text-[35px]">What is Pelvic Congestion Syndrome?</h3>
            <p className="mt-4 text-[14px] sm:text-[18px] leading-relaxed text-slate-600 max-w-full">
              Pelvic Congestion Syndrome (PCS) is a chronic condition that causes persistent pelvic pain in women, caused by enlarged and poorly functioning veins in the pelvic region similar to how <a href="/Varicose-Vein-Ablation"> varicose veins develop</a> in the legs. It primarily affects women of childbearing age and is one of the most underdiagnosed causes of long-term pelvic pain.
            </p>

            <p className="mt-2 text-[14px] sm:text-[18px] leading-relaxed text-slate-600 max-w-full">It happens mostly in women of childbearing age. It may be more common in women who have given birth to more than one child.</p>
